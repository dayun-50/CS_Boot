...
public class ContactDTO {
	...
	private String conmpany_code; // 회사 고유 코드
	private String share; // 팀 공유 여부 ( default : n, 공유설정시: y )
	
	public ContactDTO () {}
	public ContactDTO(int contact_seq, String owner_email, String name, String email, String phone,
			String contact_group, String conmpany_code, String share) {
		super();
		...
		this.conmpany_code = conmpany_code;
		this.share = share;
	}
	...
	public String getConmpany_code() {
		return conmpany_code;
	}
	public void setConmpany_code(String conmpany_code) {
		this.conmpany_code = conmpany_code;
	}
