...
public class NoticeDTO {
	...
	private int view_count; // 조회수 ( default : 0 )F
	...
	public NoticeDTO(int notice_seq, int view_count, String writer_email, String title, String content,
			String company_code, Timestamp created_at) {
		super();
